...
export default function Multiple_Span_Heading({
  ...
  return (
    <h1 className={className}>
     ...
     <span className="   text-[#262626] xl:text-[48px] xl:font-[600]  xl:leading-[180%]  xl:tracking-[-1px]  lg:text-[48px] lg:font-[600]  lg:leading-[120%]  lg:tracking-[-1px] md:text-[36px] text-center md:font-[600]  md:leading-[140%]  md:tracking-[-1px]  sm:text-center sm:text-[30px] sm:font-[600]  sm:leading-[140%]  sm:tracking-[-1px]">
        {Text_1}{" "}
