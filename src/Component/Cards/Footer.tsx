...
export default function Footer() {
  return (
    ...
    <div className="    sm:gap-[32px]  lg:gap-[40px]  flex flex-col sm:pb-[32px] lg:px-[0px] sm:px-[16px]">
      <div className="flex md:flex-col  xl:flex-row lg:flex-col lg:gap-[32px] xl:gap-[48px]  sm:mt-[32px] ">
        <div className=" flex justify-start  xl:mt-[0px] lg:mt-[40px] md:mt-[32px] lg:w-[447px] "><Image src={"/Assets/logo.svg"} alt={""} width={138} height={40} className="w-[138px] h-[35px]" />
        </div>


        <div className=" flex  max-w-[1280px] xl:justify-between  w-100%   gap-[70px] md:hidden sm:hidden lg:flex  ">
          <div className="  flex flex-col  gap-[26px]">
            <h1 className="font-[700]  text-[#1F2937] text-[20px] leading-[20px] font-[Archivo]">
              Products
            </h1>
            <p className="font-[400]  text-[#4B5563] text-[16px] lg:leading-[16px] md:leading-[150%] font-[Archivo] hover:text-[#4B5563] transition duration-300 cursor-pointer hover:scale-105">
              RAD STUDIO™
            </p>
            <p className="font-[400]  text-[#4B5563] text-[16px] leading-[16px] lg:leading-[16px] md:leading-[150%] font-[Archivo] transition duration-300 cursor-pointer hover:scale-105">
              DELPHI®
            </p>
            <p className="font-[400]  text-[#4B5563] text-[16px] leading-[16px] lg:leading-[16px] md:leading-[150%] font-[Archivo]transition duration-300 cursor-pointer hover:scale-105">
              C++BUILDER®
          ...
          <div className="  flex flex-col   gap-[26px]">
            ...
            <p className="font-[400] text-wrap text-[#4B5563] text-[16px] lg:leading-[16px]leading-[16px]md:leading-[150%] font-[Archivo]transition duration-300 cursor-pointer hover:scale-105">
          ...
          <div className="  flex flex-col    gap-[26px]">
            ...
            <p className="font-[400]  text-[#4B5563] text-[16px] leading-[16px] md:leading-[150%] lg:leading-[16px]font-[Archivo]transition duration-300 cursor-pointer hover:scale-105">
              Certifications
            </p>
            <p className="font-[400]  text-[#4B5563] text-[16px] leading-[16px]  md:leading-[150%]lg:leading-[16px]font-[Archivo]transition duration-300 cursor-pointer hover:scale-105">
              MVP Program
          ...
          <div className="  flex flex-col gap-[26px]">
            <h1 className="font-[700]  text-[#1F2937] text-[20px] leading-[20px] md:leading-[150%]lg:leading-[16px] font-[Archivo]">
              Get in Touch
            </h1>
            <p className="font-[400]  text-[#4B5563] text-[16px] leading-[16px] lg:leading-[16px]md:leading-[150%]font-[Archivo]transition duration-300 cursor-pointer hover:scale-105">
              US: 1 (512) 226-8080
      ...
      <div className="grid  sm:grid-cols-2 md:grid-cols-3  sm:gap-[48px] md:gap-[40px] xl:hidden lg:hidden ">
      ...
      <div className="flex md:justify-between  md:flex-row sm:flex-col-reverse md:item-center   sm:gap-[16px] lg:gap-[32px]">

        <div className="z-10"><p className=" z-10 font-[400] sm:text-center text-[#4B5563] text-[14px] lg:leading-[14px] md:leading-[22px] font-[Archivo]transition duration-300 cursor-pointer hover:scale-105">
