    ...
    <div className=" flex flex-col sm:gap-[8px]   xl:w-[647px] lg:w-[514px] md:w-[696px] sm:w-[370px] ">
      <div className="flex sm:justify-center lg:justify-start " >
       <Span_Heading
        ...
        <div className=" z-10 flex sm:flex-col  lg:justify-start md:justify-center md:flex-row gap-[8px]">
          
            <input
              className=" text-[#525252] text-[16px] leading-[150%]   lg:w-[361px] md:w-[386px] sm:w-[343px] z-10 font-[400]  sm:text-center  md:text-start border-[#D4D4D4] border-1 rounded-[8px]  px-[20px] py-[12px] "
              type="text"
              value="Your Email"
