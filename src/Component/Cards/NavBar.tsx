...
export default function NavBar() {
  return (
     <div className="firsttab  bg-[#262626]  flex lg:px-[80px] lg:py-[16px]  md:flex-row md:px-[24px] md:py-[16px] md:justify-between sm:flex-wrap  sm:flex-col sm:justify-center    sm:p-[16px] sm:gap-[16px] bg-red">
